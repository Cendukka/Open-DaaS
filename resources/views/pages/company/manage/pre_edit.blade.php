                    ...
                    <div class="form-group">
                        ...
                        <select name="material">
                            ...
                            @foreach (DB::table('presorted_material')->get() as $material)
                                <option value="{{$material->presorted_material_id}}" {{($material->presorted_material_id == $pre->presorted_material_id ? 'selected="selected"' : '')}}>{{title_case($material->presorted_material_name)}}</option>
                            @endforeach
                        </select>
                    </div>
